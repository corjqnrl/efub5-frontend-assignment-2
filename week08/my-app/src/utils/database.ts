...
const COLLECTION_REVIEW_NAME: string = process.env.NEXT_PUBLIC_COLLECTION_REVIEW_NAME || "";
...
const reviewCollection: Collection<Review> = db.collection<Review>(COLLECTION_REVIEW_NAME);

export { connectDB, postCollection, reviewCollection };
